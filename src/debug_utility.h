#ifndef ALGOVISU_DEBUG_UTILITY_H
#define ALGOVISU_DEBUG_UTILITY_H
...
namespace tools
{
    ...
    bool test_phrase_parser(Iterator & begin, Iterator & end,
                            Parser const& p,
                            Skipper const& s,
                            bool fullMatch = true)
    {
        namespace qi = boost::spirit::qi;
        bool r = qi::phrase_parse(begin, end, p, s);
        return (r && (!fullMatch || (begin == end)));
    }
...
#endif // ALGOVISU_DEBUG_UTILITY_H
